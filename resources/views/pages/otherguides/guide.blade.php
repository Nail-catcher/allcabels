...
<div class="breadcrumbs">
  <ul>
    ...
    <li><a href="/otherguides">Общие справочники</a></li>
  </ul>
</div>
@endsection
@section('content')
  ...
  <div class="row">
    <div class="content__header">
      <div>
        ...
        <h1>Общие справочники<a href="#" class="add" data-modal data-target="addManufacture">+</a></h1>
      </div>
      ...
      fetch(url, {
        ...
        headers: {
          ...
          'x-csrf-token': csrfToken
              ...
              .then(guide => (document.location.href = '/otherguides/'+guide.id))
    .catch(error => {
      // обработка ошибки
      console.log(error);
    });
