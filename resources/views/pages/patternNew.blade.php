    ...
    <div class="row-flex">
        ...
        <form action="" class="content__form-form">
          ...
          <fieldset class="content__form-fieldset">
            ...
            <div class="content__form-list">
              <label for="l1" class="content__form-list-item">
                <input type="checkbox" name="" id="l1">
                <p>Общий экран поверх сердечника из всех витых пар</p>
              </label>
              <label for="l2" class="content__form-list-item">
                <input type="checkbox" name="" id="l2">
                <p>Использование кабеля во взрывоопасных зонах</p>
              </label>
              <label for="l3" class="content__form-list-item">
                <input type="checkbox" name="" id="l3">
                <p>Индивидуальный экран каждой пары</p>
              </label>
              <label for="l4" class="content__form-list-item">
                <input type="checkbox" name="" id="l4">
                <p>Специальный показатель</p>
              </label>
              <label for="l5" class="content__form-list-item">
                <input type="checkbox" name="" id="l5">
                <p>Индивидуальный экран каждой пары</p>
              </label>
              <label for="l6" class="content__form-list-item">
                <input type="checkbox" name="" id="l6">
                <p>Общий экран поверх сердечника из всех витых пар</p>
              </label>
            </div>
          </fieldset>
          <fieldset class="content__form-fieldset">
            ...
            <label for="">
              <input type="text" placeholder="Введите разделитель" id="" name="">
          ...
          <fieldset class="content__form-fieldset">
            ...
            <label for="">
              <input type="text" placeholder="Введите ГОСТ или ТУ" id="" name="">
              <button class="btn btn-primary">Добавить</button>
            </label>
          </fieldset>
        </form> 
