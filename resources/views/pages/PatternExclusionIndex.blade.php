...
@section('breadcrumb')
    <div class="breadcrumbs">
        <ul>
            ...
            <li><a href="{{ url()->previous() }}">Исключения {{$pattern->name}}</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="content__list" style="flex: 0 0 100%; width: 100%;">
                ...
                <a href="/fabric/{{$pattern->id}}/exclusion/new?index=нг(А)" class="btn btn-primary" style="width: fit-content;">Подтвердить</a>
            </div>
        </div>
    </div>
    <script>
        ...
        function redir(id){
            ...
            document.location.href = ' /patternconflicts/create?guide='+guide+'&pattern='+pattern+'&index='+id;
        }
    </script>
@endsection